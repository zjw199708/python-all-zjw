from blank.untils.DBUntils import Mysqluntils
from blank.untils.Exceluntils import ExcelUntils
...
# d = DataRead('database', database='student', user='root', tablename='choose', password='')
